            ...
            <li className="!ml-[12px]">
              ...
              >
                ...
                >
                  <path
                    fill="#000000"
                    d="M236.8 84.3a58.1 58.1 0 0 1-33.5-10.8 58.3 58.3 0 0 1-11.3-10.9 58.4 58.4 0 0 1-12-36.3h-33.8v126.3a34.1 34.1 0 1 1-34-34 33.3 33.3 0 0 1 9.8 1.5v-35.3a68 68 0 1 0 24 132.1 67.9 67.9 0 0 0 34-58.8v-60.2a91.4 91.4 0 0 0 17.3 8.9 91 91 0 0 0 38.3 8.4z"
                  />
                  <path
                    fill="#25F4EE"
                    d="M236.8 84.3a58.1 58.1 0 0 1-33.5-10.8 58.3 58.3 0 0 1-11.3-10.9 58.4 58.4 0 0 1-12-36.3h-33.8v126.3a34.1 34.1 0 1 1-34-34 33.3 33.3 0 0 1 9.8 1.5v-35.3a68 68 0 1 0 24 132.1 67.9 67.9 0 0 0 34-58.8v-60.2a91.4 91.4 0 0 0 17.3 8.9 91 91 0 0 0 38.3 8.4z"
                  ...
                  <path
                    fill="#FE2C55"
                    d="M173.2 62.6a58.3 58.3 0 0 0 11.3 10.9 58.1 58.1 0 0 0 33.5 10.8v-25a58.2 58.2 0 0 1-29.7-8.1 58.5 58.5 0 0 1-15.1-11.9z"
                  />
                </svg>
              </a>
            </li>
