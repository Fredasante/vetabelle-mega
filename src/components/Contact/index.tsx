      ...
      <section className="overflow-hidden py-10 lg:py-15 bg-gray-2">
        <div className="max-w-[1170px] w-full mx-auto px-4 sm:px-8 xl:px-0">
          <div className="flex flex-col lg:flex-row gap-7.5">
            ...
            <div className="w-full lg:w-1/2 bg-white rounded-xl shadow-1 overflow-hidden">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3970.8795192690905!2d-0.2104514258224207!3d5.584820933360893!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xfdf9ba079996b7d%3A0x5f1a190bef949fe1!2sVETABELLE!5e0!3m2!1sen!2sgh!4v1774542084663!5m2!1sen!2sgh"
                width="100%"
                height="100%"
                ...
                title="Vetabelle Location - Kokomelemele, Accra"
              ></iframe>
            </div>

            {/* Contact Form with Details - Right Side */}
            <div className="w-full lg:w-1/2 bg-white rounded-xl shadow-1 p-4 sm:p-7.5 xl:p-10">
              {/* Contact Information */}
              <div className="flex flex-wrap gap-4 mb-6 pb-6 border-b border-gray-3">
                ...
                <p className="flex items-center gap-2 text-sm">
                  ...
                  Near Entrance Hospital Kokomelemele, Accra Ghana
                </p>
              </div>
              ...
              <form>
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-teal/20"
                    />
                  </div>
                ...
                <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
                  <div className="w-full">
                    ...
                    <input
                      ...
                      className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-teal/20"
                    />
                  </div>
                ...
                <div className="mb-7.5">
                  ...
                  <textarea
                    ...
                    className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full p-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-teal/20"
                  ></textarea>
                </div>

                <button
                  type="submit"
                  className="inline-flex font-medium text-white bg-[#c77f56] py-3 px-7 rounded-md ease-out duration-200 hover:bg-opacity-90"
                >
                  Send Message
                </button>
              </form>
